  ...
  export default function DetailPokemon() {
    ...
    const [officialSrc, setOfficialSrc] = useState(data.official);

    const handleToggle = () => {
      setOfficialSrc((prevSrc) => (prevSrc === data.official ? data.shiny_official : data.official));
    };
